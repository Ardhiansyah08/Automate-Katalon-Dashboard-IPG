...
if (Member_Bank.startsWith("MTIISO")) {
	...
	WebUI.callTestCase(findTestCase('Test Cases/Postgre/Testcase Detail/Payment/Installment/Installment MTIISO'), dataExcel)
	
} else if (Member_Bank.startsWith("OCBCISO")) {

	println("Start OCBCISO")
	WebUI.callTestCase(findTestCase('Test Cases/Postgre/Testcase Detail/Payment/Installment/Installment OCBCISO'), dataExcel)
	
} else if (Member_Bank.startsWith("BTN")) {

	println("Start BTN")
	WebUI.callTestCase(findTestCase('Test Cases/Postgre/Testcase Detail/Payment/Installment/Installment BTN'), dataExcel)
	
} else if (Member_Bank.startsWith("CIMB")) {

	println("Start CIMB")
	WebUI.callTestCase(findTestCase('Test Cases/Postgre/Testcase Detail/Payment/Installment/Installment CIMB'), dataExcel)
