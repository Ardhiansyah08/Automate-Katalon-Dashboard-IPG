...
WebUI.callTestCase(findTestCase('Test Cases/Postgre/Testcase Detail/Payment/Virtual Account/Create Mandiri Virtual Account'), [('path_dokumen') : wordPath], FailureHandling.STOP_ON_FAILURE)
