...
//	
//		if (visible2) {
//			WebUI.click(findTestObject('Object Repository/Page_PG Admin/Page_PG Admin/span_Search'))
//			WebUI.setText(findTestObject('Object Repository/Page_PG Admin/Page_PG Admin/input_To date_MuiInputBase-input MuiOutline_c3fd1c'), referenceId)
