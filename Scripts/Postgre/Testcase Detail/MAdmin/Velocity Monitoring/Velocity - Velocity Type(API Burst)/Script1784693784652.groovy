...
runTitleValue.setText("Menu Velocity Monitoring - Velocity Type(API Burst)")
...
XWPFRun runAPIBValue = paragraph.createRun()

FileInputStream is1 = new FileInputStream(SS1)
runAPIBValue.addPicture(is1, XWPFDocument.PICTURE_TYPE_PNG, SS1, Units.toEMU(500), Units.toEMU(230))
is1.close()
