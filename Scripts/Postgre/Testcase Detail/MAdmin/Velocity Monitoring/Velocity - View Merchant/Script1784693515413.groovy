...
runTitleValue.setText("Menu Velocity Monitoring - View Merchant")
...
XWPFRun runVMerchantValue = paragraph.createRun()

FileInputStream is1 = new FileInputStream(SS1)
runVMerchantValue.addPicture(is1, XWPFDocument.PICTURE_TYPE_PNG, SS1, Units.toEMU(500), Units.toEMU(230))
is1.close()

FileInputStream is2 = new FileInputStream(SS2)
runVMerchantValue.addPicture(is2, XWPFDocument.PICTURE_TYPE_PNG, SS2, Units.toEMU(500), Units.toEMU(230))
is2.close()
