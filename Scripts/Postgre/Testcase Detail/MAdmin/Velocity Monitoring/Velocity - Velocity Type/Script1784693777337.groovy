...
runTitleValue.setText("Menu Velocity Monitoring - List Velocity Type")
...
XWPFRun runVeloTypeValue = paragraph.createRun()

FileInputStream is1 = new FileInputStream(SS1)
runVeloTypeValue.addPicture(is1, XWPFDocument.PICTURE_TYPE_PNG, SS1, Units.toEMU(500), Units.toEMU(230))
is1.close()
