...
runTitleValue.setText("Reset Password Email Valid")
...
while ((System.currentTimeMillis() - startTime) < maxWaitTimeMs) {
	...
	if (visible) {
		...
		WebUI.setText(findTestObject('Object Repository/Reset Password/input_Username_email'), 'ardhiansyah356@gmail.com')
