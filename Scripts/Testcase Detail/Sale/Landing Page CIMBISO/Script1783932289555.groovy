...
//WebUI.openBrowser('https://tst.yokke.co.id:2443/checkout/jCxqAGjR5W3tL4acrwSNRN')
WebUI.maximizeWindow()

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Nav/Page_Yokke/p_CreditDebit CIMB'))
WebUI.setText(findTestObject('Object Repository/Nav/input_Name_MuiInputBase-input MuiFilledInput-input'), Name)
WebUI.setText(findTestObject('Nav/Page_Yokke/input_0000 0000 0000 0000_1'), CardData)
WebUI.setText(findTestObject('Nav/Page_Yokke/input_MM _ YY_1'), Expired)
