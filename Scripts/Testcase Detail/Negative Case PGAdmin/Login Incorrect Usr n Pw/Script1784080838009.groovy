...
runTitleValue.setText("LOGIN INCROCCERT ACC PAGE ADMIN")
runTitleValue.addBreak()
runTitleValue.setText("--------------------------------------------------")
runTitleValue.addBreak()
runTitleValue.setText(GlobalVariable.currentTestCaseName)
runTitleValue.addBreak()
...
while ((System.currentTimeMillis() - startTime) < maxWaitTimeMs) {
	...
	if (visible) {
		//Login PGAdmin
		WebUI.setText(findTestObject('Object Repository/Page_PG Admin/input_Username  Email_username'), 'ferasantika15@gmail.com')
...
runHasilValue.addPicture(is1, XWPFDocument.PICTURE_TYPE_PNG, SS2, Units.toEMU(500), Units.toEMU(230))
is2.close()
