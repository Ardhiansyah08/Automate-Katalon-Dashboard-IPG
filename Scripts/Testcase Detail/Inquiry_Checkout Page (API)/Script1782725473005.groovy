...
runUrlValue.setFontSize(11) // Ukuran normal (silakan sesuaikan)
...
runStatusValue.setText(responseInquiry.getStatusCode().toString()) // Ditambah .toString() untuk mencegah error tipe data angka
...
runResBodyLabel.addBreak() // <-- Ubah run.addBreak() jadi runResBodyLabel.addBreak()
