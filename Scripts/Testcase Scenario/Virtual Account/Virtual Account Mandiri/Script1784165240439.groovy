...
WebUI.callTestCase(findTestCase('Test Cases/Testcase Detail/Virtual Account/Create Mandiri Virtual Account'), [('path_dokumen') : wordPath], FailureHandling.STOP_ON_FAILURE)
